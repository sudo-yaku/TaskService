var Directive = function(obj){
    ...
    this.directive_unid = obj.meta_universalid,
    ...
    this.platform = "";
    if( obj.cfd_elementname ){
        var pltdtls = obj.cfd_elementname.split("::");
        if(pltdtls && pltdtls.length == 3){
            this.platform = pltdtls[1] + "::" + pltdtls[2];
        } else if(pltdtls && pltdtls.length == 2){
            this.platform = pltdtls[0] + "::" + pltdtls[1];
        }
    }

    this.directiveid = "";
    if( obj.cfd_tr_directiveid ){
        this.directiveid = obj.cfd_tr_directiveid;
    }
};
